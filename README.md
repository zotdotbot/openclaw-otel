...
(`schema.version` `1.6.0`) — see [CONTRACT.md](CONTRACT.md).
...
No special flags are needed — it's a single self-contained bundle whose only side
effect is an outbound OTLP connection. (Requires OpenClaw ≥ 2026.4.21.)
